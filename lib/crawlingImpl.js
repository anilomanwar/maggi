...
Crawler.prototype._release = function _release (options) {
    ...
    // Pool stats are behaving weird - have to implement our own counter -- changig this implementation to test a bug
    if (self.queueItemSize + self.plannedQueueCallsCount === 0) {
        self.emit('pool:drain');
    } 
  /*  if (self.queueItemSize === 0) {
        self.emit('pool:drain');
    } */
};
...
Crawler.prototype._buildHttpRequest = function _buildHTTPRequest (options) {
    ...
    if (typeof ropts.encoding === 'undefined') {
        ropts.headers['Accept-Encoding'] = 'gzip, deflate, sdch';
        ropts.encoding = null;
    }
    if (ropts.userAgent) {
	...
	//ropts.headers['Accept-Language'] = "en-US,en;q=0.8,hi;q=0.6"
	//ropts.headers['Host'] = "www.pepperfry.com"
	//ropts.headers['Cookie'] = "unbxd.userId=uid-1429969495746-77963; gtm_ecommerce_event=0; _ga=GA1.2.656607606.1429969482; _dc_gtm_UA-25959246-1=1; frontend=53ffa9bd2fb1dca6c5b34ace2758e91d1912ec10d968a99337403e3d4f9e4f51; csrf_token=c14e9da48b5518f26be4bf61290f6130f056fda34a51388f6a226cedd83afa16; unbxd.visit=repeat; _we_wk_ss_lsf_=true; PRUM_EPISODES=s=1430069966636&r=http%3A//www.pepperfry.com/mark-home-aqua-color-cotton-2-single-bed-sheets-n-2-pillow-covers-1197983.html"
    var requestArgs = ['uri','url','qs','method','headers','body','form','json','multipart','followRedirect',
        ...
        'jar','aws'];
	var reqopts=_.pick.apply(this,[ropts].concat(requestArgs));
	//reqopts.agentClass=Agent;
   // reqopts.agentOptions={
   //     socksHost: 'localhost', // Defaults to 'localhost'.
    //    socksPort: 9050 // Defaults to 1080.
    //}
    var req = request(reqopts, function(error,response) {
        if (error) {
